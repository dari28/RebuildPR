...
#             new_match['length_match'] = end_origin - \
#                                     shift_map[end_origin] - new_match[
#                                         'start_match'] + 1
...
#             while match[0] > end_pos:
#                 n_word += 1
#                 utf8_units = self.units[n_word] if isinstance(self.units[n_word], unicode) \
#                     else self.units[n_word].decode('utf8')
...
#     def __init__(self, matches, text, units, units_tag=None):
#         self.matches = matches
#         self.origin_text =  text if isinstance(text, unicode) else text.decode('utf8')
#         self.units = units
#         self.units_tag = units_tag
#
#     def __iter__(self):
